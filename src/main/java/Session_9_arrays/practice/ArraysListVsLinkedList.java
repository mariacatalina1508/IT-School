...
public class ArraysListVsLinkedList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ArrayList list time: " + (endTimerArrayList - startTimerArrayList));
        System.out.println("linkedList list time: " + (endTimerArrayList - startTimerLinkedList));
    }
}